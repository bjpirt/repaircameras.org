...
- 1/8s, 1/15s, 1/30s are all controlled by the slow speed escapement when it is disengaged and using only the weight of the gears to slow it down
  1/60s - 1/1000s are all controlled by the high speed cam which is rotated by the first shutter and triggers the second shutter after a certain amount of travel
